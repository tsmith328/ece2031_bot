...
<h3 class="fn"><a name="propertyNames" />list-of-QByteArray QVideoSurfaceFormat.propertyNames (<i>self</i>)</h3><p>Returns a list of video format dynamic property names.</p>
