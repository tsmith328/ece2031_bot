...
</style></head><body><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr /><td align="left" valign="top" width="32"><img align="left" border="0" height="32" src="images/rb-logo.png" width="32" /></td><td width="1">&#160;&#160;</td><td class="postheader" valign="center"><a href="index.html"><font color="#004faf">Home</font></a>&#160;&#183; <a href="classes.html"><font color="#004faf">All Classes</font></a>&#160;&#183; <a href="modules.html"><font color="#004faf">Modules</font></a></td></table><h1 align="center">QDesignerMemberSheetExtension Class Reference<br /><sup><sup>[<a href="qtdesigner.html">QtDesigner</a> module]</sup></sup></h1><p>The QDesignerMemberSheetExtension class allows you to manipulate
...
<pre class="cpp">
 <span class="type">QDesignerMemberSheetExtension</span> <span class="operator">*</span>memberSheet  <span class="operator">=</span> <span class="number">0</span>;
 ...
 memberSheet <span class="operator">=</span> qt_extension<span class="operator">&lt;</span><span class="type">QDesignerMemberSheetExtension</span><span class="operator">*</span><span class="operator">&gt;</span>(manager<span class="operator">,</span> widget);
 <span class="type">int</span> index <span class="operator">=</span> memberSheet<span class="operator">-</span><span class="operator">&gt;</span><a href="qdesignermembersheetextension.html#indexOf">indexOf</a>(setEchoMode);
 memberSheet<span class="operator">-</span><span class="operator">&gt;</span><a href="qdesignermembersheetextension.html#setVisible">setVisible</a>(index<span class="operator">,</span> <span class="keyword">false</span>);
...
<pre class="cpp">
 <span class="keyword">class</span> MyMemberSheetExtension : <span class="keyword">public</span> <span class="type"><a href="qobject.html">QObject</a></span><span class="operator">,</span>
         <span class="keyword">public</span> <span class="type">QDesignerMemberSheetExtension</span>
 {
     Q_OBJECT
     Q_INTERFACES(<span class="type">QDesignerMemberSheetExtension</span>)
...
<pre class="cpp">
 ...
 {
     <span class="keyword">if</span> (iid <span class="operator">!</span><span class="operator">=</span> Q_TYPEID(<span class="type">QDesignerMemberSheetExtension</span>))
...
<pre class="cpp">
         ...
         <span class="keyword">const</span> <span class="type"><a href="qstring.html">QString</a></span> <span class="operator">&amp;</span>iid<span class="operator">,</span> <span class="type"><a href="qobject.html">QObject</a></span> <span class="operator">*</span>parent) <span class="keyword">const</span>
 {
     ...
     } <span class="keyword">else</span> <span class="keyword">if</span> (widget <span class="operator">&amp;</span><span class="operator">&amp;</span> (iid <span class="operator">=</span><span class="operator">=</span> Q_TYPEID(<span class="type">QDesignerMemberSheetExtension</span>))) {
         <span class="keyword">return</span> <span class="keyword">new</span> MyMemberSheetExtension(widget<span class="operator">,</span> parent);
...
otherwise false.</p>
<p><b>See also</b> <a href="qdesignermembersheetextension.html#indexOf">indexOf</a>() and
...
<i>index</i>.</p>
<p><b>See also</b> <a href="qdesignermembersheetextension.html#indexOf">indexOf</a>().</p>
<h3 class="fn"><a name="__len__" /> QDesignerMemberSheetExtension.__len__ (<i>self</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.10.4 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://qt.digia.com">Digia</a> 2014</td><td align="right" width="25%">Qt&#160;4.8.5</td></tr></table></div></address></body></html>