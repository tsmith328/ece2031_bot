...
<html><head><title>QXmlSimpleReader Class Reference</title><style>h3.fn,span.fn { margin-left: 1cm; text-indent: -1cm }
a:link { color: #004faf; text-decoration: none }
a:visited { color: #672967; text-decoration: none }
td.postheader { font-family: sans-serif }
tr.address { font-family: sans-serif }
body { background: #ffffff; color: black; }
</style></head><body><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr /><td align="left" valign="top" width="32"><img align="left" border="0" height="32" src="images/rb-logo.png" width="32" /></td><td width="1">&#160;&#160;</td><td class="postheader" valign="center"><a href="index.html"><font color="#004faf">Home</font></a>&#160;&#183; <a href="classes.html"><font color="#004faf">All Classes</font></a>&#160;&#183; <a href="modules.html"><font color="#004faf">Modules</font></a></td></table><h1 align="center">QXmlSimpleReader Class Reference<br /><sup><sup>[<a href="qtxml.html">QtXml</a> module]</sup></sup></h1><p>The QXmlSimpleReader class provides an implementation of a
...
<pre class="cpp">
     <span class="type">QXmlSimpleReader</span> xmlReader;
...
<pre class="cpp">
     <span class="type">bool</span> ok <span class="operator">=</span> xmlReader<span class="operator">.</span>parse(source);
...
<pre class="cpp">
 xmlReader<span class="operator">.</span><a href="qxmlsimplereader.html#setFeature">setFeature</a>(<span class="string">"http://xml.org/sax/features/namespace-prefixes"</span><span class="operator">,</span> <span class="keyword">true</span>);
</pre>
...
<h3 class="fn"><a name="feature" />(bool, bool&#160;<i>ok</i>) QXmlSimpleReader.feature (<i>self</i>, QString&#160;<i>name</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#feature">QXmlReader.feature</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#setFeature">setFeature</a>().</p>


<h3 class="fn"><a name="hasFeature" />bool QXmlSimpleReader.hasFeature (<i>self</i>, QString&#160;<i>name</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#hasFeature">QXmlReader.hasFeature</a>().</p>


<h3 class="fn"><a name="hasProperty" />bool QXmlSimpleReader.hasProperty (<i>self</i>, QString&#160;<i>name</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#hasProperty">QXmlReader.hasProperty</a>().</p>
...
<h3 class="fn"><a name="parse" />bool QXmlSimpleReader.parse (<i>self</i>, <a href="qxmlinputsource.html">QXmlInputSource</a>&#160;<i>input</i>)</h3><p>Reimplemented from <a class="obsolete" href="qxmlreader-obsolete.html#parse-2">QXmlReader.parse</a>().</p>


<h3 class="fn"><a name="parse-2" />bool QXmlSimpleReader.parse (<i>self</i>, <a href="qxmlinputsource.html">QXmlInputSource</a>&#160;<i>input</i>, bool&#160;<i>incremental</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#parse">QXmlReader.parse</a>().</p>
...
<p><b>See also</b> <a href="qxmlsimplereader.html#parse">parse</a>(), <a href="qxmlinputsource.html#data">QXmlInputSource.data</a>(), and
<a href="qxmlinputsource.html#next">QXmlInputSource.next</a>().</p>


<h3 class="fn"><a name="property" />(sip.voidptr, bool&#160;<i>ok</i>) QXmlSimpleReader.property (<i>self</i>, QString&#160;<i>name</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#property">QXmlReader.property</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#setProperty">setProperty</a>().</p>


<h3 class="fn"><a name="setContentHandler" />QXmlSimpleReader.setContentHandler (<i>self</i>, <a href="qxmlcontenthandler.html">QXmlContentHandler</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setContentHandler">QXmlReader.setContentHandler</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#contentHandler">contentHandler</a>().</p>


<h3 class="fn"><a name="setDeclHandler" />QXmlSimpleReader.setDeclHandler (<i>self</i>, <a href="qxmldeclhandler.html">QXmlDeclHandler</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setDeclHandler">QXmlReader.setDeclHandler</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#declHandler">declHandler</a>().</p>


<h3 class="fn"><a name="setDTDHandler" />QXmlSimpleReader.setDTDHandler (<i>self</i>, <a href="qxmldtdhandler.html">QXmlDTDHandler</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setDTDHandler">QXmlReader.setDTDHandler</a>().</p>


<h3 class="fn"><a name="setEntityResolver" />QXmlSimpleReader.setEntityResolver (<i>self</i>, <a href="qxmlentityresolver.html">QXmlEntityResolver</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setEntityResolver">QXmlReader.setEntityResolver</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#entityResolver">entityResolver</a>().</p>


<h3 class="fn"><a name="setErrorHandler" />QXmlSimpleReader.setErrorHandler (<i>self</i>, <a href="qxmlerrorhandler.html">QXmlErrorHandler</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setErrorHandler">QXmlReader.setErrorHandler</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#errorHandler">errorHandler</a>().</p>


<h3 class="fn"><a name="setFeature" />QXmlSimpleReader.setFeature (<i>self</i>, QString&#160;<i>name</i>, bool&#160;<i>value</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setFeature">QXmlReader.setFeature</a>().</p>
...
<td><i>http://xml.org/sax/features/namespaces</i></td>
<td>true</td>
<td>If enabled, namespaces are reported to the content
handler.</td>
</tr>
<tr class="even" valign="top">
<td><i>http://xml.org/sax/features/namespace-prefixes</i></td>
<td>false</td>
<td>If enabled, the original prefixed names and attributes used for
namespace declarations are reported.</td>
</tr>
<tr class="odd" valign="top">
<td>
<i>http://trolltech.com/xml/features/report-whitespace-only-CharData</i></td>
<td>true</td>
<td>If enabled, CharData that consist of only whitespace characters
are reported using <a href="qxmlcontenthandler.html#characters">QXmlContentHandler.characters</a>().
If disabled, whitespace is silently discarded.</td>
</tr>
<tr class="even" valign="top">
<td>
<i>http://trolltech.com/xml/features/report-start-end-entity</i></td>
<td>false</td>
<td>If enabled, the parser reports
...
character data in one chunk.</td>
</tr>
</table>
...
<h3 class="fn"><a name="setLexicalHandler" />QXmlSimpleReader.setLexicalHandler (<i>self</i>, <a href="qxmllexicalhandler.html">QXmlLexicalHandler</a>&#160;<i>handler</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setLexicalHandler">QXmlReader.setLexicalHandler</a>().</p>
<p><b>See also</b> <a href="qxmlsimplereader.html#lexicalHandler">lexicalHandler</a>().</p>


<h3 class="fn"><a name="setProperty" />QXmlSimpleReader.setProperty (<i>self</i>, QString&#160;<i>name</i>, sip.voidptr&#160;<i>value</i>)</h3><p>Reimplemented from <a href="qxmlreader.html#setProperty">QXmlReader.setProperty</a>().</p>
