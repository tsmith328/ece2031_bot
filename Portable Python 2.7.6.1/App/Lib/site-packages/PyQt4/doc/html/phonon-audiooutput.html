...
backend.</p>
<hr /><h2>Method Documentation</h2><h3 class="fn"><a name="AudioOutput" />AudioOutput.__init__ (<i>self</i>, <a href="phonon.html#Category-enum">Category</a>&#160;<i>category</i>, <a href="qobject.html">QObject</a>&#160;<i>parent</i>&#160;=&#160;None)</h3><p>The <i>parent</i> argument, if not None, causes <i>self</i> to be owned by Qt instead of PyQt.</p><p>Creates a new <a href="phonon-audiooutput.html">AudioOutput</a>
with the given <i>parent</i> that defines output to a physical
device.</p>
<p>The <i>category</i> can be used by mixer applications to group
volume controls of applications into categories. That makes it
easier for the user to identify the programs. The category is also
used for the default output device that is configured centrally. As
an example: often users want to have the audio signal of a VoIP
application go to their USB headset while all other sounds should
go to the internal soundcard.</p>
...
<h3 class="fn"><a name="AudioOutput-2" />AudioOutput.__init__ (<i>self</i>, <a href="qobject.html">QObject</a>&#160;<i>parent</i>&#160;=&#160;None)</h3><p>The <i>parent</i> argument, if not None, causes <i>self</i> to be owned by Qt instead of PyQt.</p><p>Creates a new <a href="phonon-audiooutput.html">AudioOutput</a>
...
<p><b>See also</b> <a href="phonon-audiooutput.html#AudioOutput">Phonon.AudioOutput.AudioOutput</a>().</p>
