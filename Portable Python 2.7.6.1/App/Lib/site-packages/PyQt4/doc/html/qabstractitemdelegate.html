...
</style></head><body><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr /><td align="left" valign="top" width="32"><img align="left" border="0" height="32" src="images/rb-logo.png" width="32" /></td><td width="1">&#160;&#160;</td><td class="postheader" valign="center"><a href="index.html"><font color="#004faf">Home</font></a>&#160;&#183; <a href="classes.html"><font color="#004faf">All Classes</font></a>&#160;&#183; <a href="modules.html"><font color="#004faf">Modules</font></a></td></table><h1 align="center">QAbstractItemDelegate Class Reference<br /><sup><sup>[<a href="qtgui.html">QtGui</a> module]</sup></sup></h1><p>The QAbstractItemDelegate class is used to display and edit data
...
<p class="centerAlign"><img alt="" src="images/widgetdelegate.png" /></p>
...
<pre class="cpp">
                            ...
                            <span class="keyword">const</span> <span class="type"><a href="qmodelindex.html">QModelIndex</a></span> <span class="operator">&amp;</span>index) <span class="keyword">const</span>
 {
     <span class="keyword">if</span> (index<span class="operator">.</span>column() <span class="operator">=</span><span class="operator">=</span> <span class="number">1</span>) {
         <span class="type">int</span> progress <span class="operator">=</span> index<span class="operator">.</span>data()<span class="operator">.</span>toInt();

         <span class="type"><a href="qstyleoptionprogressbar.html">QStyleOptionProgressBar</a></span> progressBarOption;
         progressBarOption<span class="operator">.</span>rect <span class="operator">=</span> option<span class="operator">.</span>rect;
         progressBarOption<span class="operator">.</span>minimum <span class="operator">=</span> <span class="number">0</span>;
         progressBarOption<span class="operator">.</span>maximum <span class="operator">=</span> <span class="number">100</span>;
         progressBarOption<span class="operator">.</span>progress <span class="operator">=</span> progress;
         progressBarOption<span class="operator">.</span>text <span class="operator">=</span> <span class="type"><a href="qstring.html">QString</a></span><span class="operator">.</span>number(progress) <span class="operator">+</span> <span class="string">"%"</span>;
         progressBarOption<span class="operator">.</span>textVisible <span class="operator">=</span> <span class="keyword">true</span>;

         <span class="type"><a href="qapplication.html">QApplication</a></span><span class="operator">.</span>style()<span class="operator">-</span><span class="operator">&gt;</span>drawControl(<span class="type"><a href="qstyle.html">QStyle</a></span><span class="operator">.</span>CE_ProgressBar<span class="operator">,</span>
                                            <span class="operator">&amp;</span>progressBarOption<span class="operator">,</span> painter);
...
<p><b>See also</b> <a href="qabstractitemdelegate.html#setModelData">setModelData</a>() and
...
<p><b>See also</b> <a href="qhelpevent.html">QHelpEvent</a>.</p>
...
<h3 class="fn"><a name="setEditorData" />QAbstractItemDelegate.setEditorData (<i>self</i>, <a href="qwidget.html">QWidget</a>&#160;<i>editor</i>, <a href="qmodelindex.html">QModelIndex</a>&#160;<i>index</i>)</h3><p>Sets the contents of the given <i>editor</i> to the data for the
...
you will need to reimplement this function.</p>
<p><b>See also</b> <a href="qabstractitemdelegate.html#setModelData">setModelData</a>().</p>


<h3 class="fn"><a name="setModelData" />QAbstractItemDelegate.setModelData (<i>self</i>, <a href="qwidget.html">QWidget</a>&#160;<i>editor</i>, <a href="qabstractitemmodel.html">QAbstractItemModel</a>&#160;<i>model</i>, <a href="qmodelindex.html">QModelIndex</a>&#160;<i>index</i>)</h3><p>Sets the data for the item at the given <i>index</i> in the
<i>model</i> to the contents of the given <i>editor</i>.</p>
<p>The base implementation does nothing. If you want custom editing
you will need to reimplement this function.</p>
<p><b>See also</b> <a href="qabstractitemdelegate.html#setEditorData">setEditorData</a>().</p>
...
<p><b>See also</b> <a href="qabstractitemdelegate.html#EndEditHint-enum">EndEditHint</a>.</p>
