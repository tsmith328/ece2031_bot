...
<pre class="cpp">
 <span class="type">bool</span> checkUrl(<span class="keyword">const</span> <span class="type"><a href="qurl.html">QUrl</a></span> <span class="operator">&amp;</span>url) {
     <span class="keyword">if</span> (<span class="operator">!</span>url<span class="operator">.</span>isValid()) {
         <a href="qtcore.html#qDebug">qDebug</a>(<span class="type"><a href="qstring.html">QString</a></span>(<span class="string">"Invalid URL: %1"</span>)<span class="operator">.</span>arg(url<span class="operator">.</span>toString()));
...
<pre class="cpp">
 ...
 <a href="qtcore.html#qDebug">qDebug</a>(baseUrl<span class="operator">.</span>resolved(relativeUrl)<span class="operator">.</span>toString());
