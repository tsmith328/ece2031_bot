...
<h3 class="fn"><a name="buttons" />list-of-QAbstractButton QDialogButtonBox.buttons (<i>self</i>)</h3><p>Returns a list of all the buttons that have been added to the
button box.</p>
