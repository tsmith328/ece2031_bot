...
<h3 class="fn"><a name="attribute" />QVariant QNetworkReply.attribute (<i>self</i>, <a href="qnetworkrequest.html#Attribute-enum">QNetworkRequest.Attribute</a>&#160;<i>code</i>)</h3><h3 class="fn"><a name="close" />QNetworkReply.close (<i>self</i>)</h3><p>Reimplemented from <a href="qiodevice.html#close">QIODevice.close</a>().</p>
...
errors reported by the <a href="qnetworkreply.html#sslErrors">sslErrors</a>() signal, and only
call this method upon confirmation from the user that proceeding is
ok. If there are unexpected errors, the reply should be aborted.
...
<p><b>See also</b> <a href="qnetworkreply.html#attributex">attribute</a>() and <a href="qnetworkrequest.html#setAttribute">QNetworkRequest.setAttribute</a>().</p>
