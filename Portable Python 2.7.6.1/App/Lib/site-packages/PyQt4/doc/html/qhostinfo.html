...
<h3 class="fn"><a name="addresses" />list-of-QHostAddress QHostInfo.addresses (<i>self</i>)</h3><p>Returns the list of IP addresses associated with <a href="qhostinfo.html#hostName">hostName</a>(). This list may be
empty.</p>
<p>Example:</p>
<pre class="cpp">
...
<h3 class="fn"><a name="lookupHost" />int QHostInfo.lookupHost (QString&#160;<i>name</i>, <a href="qobject.html">QObject</a>&#160;<i>receiver</i>, SLOT(QHostInfo)SLOT()&#160;<i>member</i>)</h3><p>Looks up the IP address(es) associated with host name
...
<h3 class="fn"><a name="lookupHost-2" />int QHostInfo.lookupHost (QString&#160;<i>name</i>, callable&#160;<i>receiver</i>)</h3><h3 class="fn"><a name="lookupId" />int QHostInfo.lookupId (<i>self</i>)</h3><p>Returns the ID of this lookup.</p>
...
<h3 class="fn"><a name="setAddresses" />QHostInfo.setAddresses (<i>self</i>, list-of-QHostAddress&#160;<i>addresses</i>)</h3><p>Sets the list of addresses in this <a href="qhostinfo.html">QHostInfo</a> to <i>addresses</i>.</p>
