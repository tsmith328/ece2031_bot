...
<h3 class="fn"><a name="findItems" />list-of-QListWidgetItem QListWidget.findItems (<i>self</i>, QString&#160;<i>text</i>, <a href="qt-matchflags.html">Qt.MatchFlags</a>&#160;<i>flags</i>)</h3><p>Finds items with the text that matches the string <i>text</i>
...
<h3 class="fn"><a name="items" />list-of-QListWidgetItem QListWidget.items (<i>self</i>, <a href="qmimedata.html">QMimeData</a>&#160;<i>data</i>)</h3><p>Returns a list of pointers to the items contained in the
...
<h3 class="fn"><a name="mimeData" /><a href="qmimedata.html">QMimeData</a> QListWidget.mimeData (<i>self</i>, list-of-QListWidgetItem&#160;<i>items</i>)</h3><p>The <i>QMimeData</i> result</p><p>Returns an object that contains a serialized description of the
...
<h3 class="fn"><a name="selectedItems" />list-of-QListWidgetItem QListWidget.selectedItems (<i>self</i>)</h3><p>Returns a list of all selected items in the list widget.</p>
...
<i>item</i>.</p>
<h3 class="fn"><a name="__len__" /> QListWidget.__len__ (<i>self</i>)</h3><hr /><h2>Qt Signal Documentation</h2><h3 class="fn"><a name="currentItemChanged" />void currentItemChanged (QListWidgetItem *,QListWidgetItem *)</h3><p>This is the default overload of this signal.</p><p>This signal is emitted whenever the current item changes.</p>
