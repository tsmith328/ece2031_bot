...
<h3 class="fn"><a name="winEvent" />(bool, int&#160;<i>result</i>) QSizeGrip.winEvent (<i>self</i>, <a href="msg.html">MSG</a>&#160;<i>m</i>)</h3><p>Reimplemented from <a href="qwidget.html#winEvent">QWidget.winEvent</a>().</p>
