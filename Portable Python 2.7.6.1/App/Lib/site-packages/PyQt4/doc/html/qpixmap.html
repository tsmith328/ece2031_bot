...
<hr /><h2>Type Documentation</h2><h3 class="fn"><a name="HBitmapFormat-enum" />QPixmap.HBitmapFormat</h3><p><b>Win32 only:</b> This enum defines how the conversion between
<tt>HBITMAP</tt> and <a href="qpixmap.html">QPixmap</a> is
performed.</p>
...
<tr>
<td class="topAlign"><tt>QPixmap.NoAlpha</tt></td>
<td class="topAlign"><tt>0</tt></td>
<td class="topAlign">The alpha channel is ignored and always
treated as being set to fully opaque. This is preferred if the
<tt>HBITMAP</tt> is used with standard GDI calls, such as
<tt>BitBlt()</tt>.</td>
</tr>
<tr>
<td class="topAlign"><tt>QPixmap.PremultipliedAlpha</tt></td>
<td class="topAlign"><tt>1</tt></td>
<td class="topAlign">The <tt>HBITMAP</tt> is treated as having an
alpha channel and premultiplied colors. This is preferred if the
<tt>HBITMAP</tt> is accessed through the <tt>AlphaBlend()</tt> GDI
function.</td>
</tr>
<tr>
<td class="topAlign"><tt>QPixmap.Alpha</tt></td>
<td class="topAlign"><tt>2</tt></td>
<td class="topAlign">The <tt>HBITMAP</tt> is treated as having a
plain alpha channel. This is the preferred format if the
<tt>HBITMAP</tt> is going to be used as an application icon or
systray icon.</td>
</tr>
</table>
<p><b>See also</b> <a href="qpixmap.html#fromWinHBITMAP">fromWinHBITMAP</a>() and <a href="qpixmap.html#toWinHBITMAP">toWinHBITMAP</a>().</p>
...
<h3 class="fn"><a name="fromWinHBITMAP" /><a href="qpixmap.html">QPixmap</a> QPixmap.fromWinHBITMAP (sip.voidptr&#160;<i>bitmap</i>, <a href="qpixmap.html#HBitmapFormat-enum">HBitmapFormat</a>&#160;<i>format</i>&#160;=&#160;QPixmap.NoAlpha)</h3><p><b>Win32 only:</b> Returns a <a href="qpixmap.html">QPixmap</a>
that is equivalent to the given <i>bitmap</i>. The conversion is
based on the specified <i>format</i>.</p>
<p><b>Warning:</b> This function is only available on Windows.</p>
<p><b>See also</b> <a href="qpixmap.html#toWinHBITMAP">toWinHBITMAP</a>() and <a href="qpixmap.html#pixmap-conversion">Pixmap Conversion</a>.</p>


<h3 class="fn"><a name="fromWinHICON" /><a href="qpixmap.html">QPixmap</a> QPixmap.fromWinHICON (sip.voidptr&#160;<i>icon</i>)</h3><p><b>Win32 only:</b> Returns a <a href="qpixmap.html">QPixmap</a>
that is equivalent to the given <i>icon</i>.</p>
<p><b>Warning:</b> This function is only available on Windows.</p>
<p>This function was introduced in Qt 4.6.</p>
<p><b>See also</b> <a href="qpixmap.html#toWinHICON">toWinHICON</a>() and <a href="qpixmap.html#pixmap-conversion">Pixmap Conversion</a>.</p>
...
<h3 class="fn"><a name="grabWindow" /><a href="qpixmap.html">QPixmap</a> QPixmap.grabWindow (sip.voidptr&#160;<i>window</i>, int&#160;<i>x</i>&#160;=&#160;0, int&#160;<i>y</i>&#160;=&#160;0, int&#160;<i>width</i>&#160;=&#160;-1, int&#160;<i>height</i>&#160;=&#160;-1)</h3><p>Creates and returns a pixmap constructed by grabbing the
...
<h3 class="fn"><a name="toWinHBITMAP" />sip.voidptr QPixmap.toWinHBITMAP (<i>self</i>, <a href="qpixmap.html#HBitmapFormat-enum">HBitmapFormat</a>&#160;<i>format</i>&#160;=&#160;QPixmap.NoAlpha)</h3><p><b>Win32 only:</b> Creates a <tt>HBITMAP</tt> equivalent to the
<a href="qpixmap.html">QPixmap</a>, based on the given
<i>format</i>. Returns the <tt>HBITMAP</tt> handle.</p>
<p>It is the caller's responsibility to free the <tt>HBITMAP</tt>
data after use.</p>
<p><b>Warning:</b> This function is only available on Windows.</p>
<p><b>See also</b> <a href="qpixmap.html#fromWinHBITMAP">fromWinHBITMAP</a>() and <a href="qpixmap.html#pixmap-conversion">Pixmap Conversion</a>.</p>


<h3 class="fn"><a name="toWinHICON" />sip.voidptr QPixmap.toWinHICON (<i>self</i>)</h3><p><b>Win32 only:</b> Creates a <tt>HICON</tt> equivalent to the
<a href="qpixmap.html">QPixmap</a>. Returns the <tt>HICON</tt>
handle.</p>
<p>It is the caller's responsibility to free the <tt>HICON</tt>
data after use.</p>
<p><b>Warning:</b> This function is only available on Windows.</p>
<p>This function was introduced in Qt 4.6.</p>
<p><b>See also</b> <a href="qpixmap.html#fromWinHICON">fromWinHICON</a>() and <a href="qpixmap.html#pixmap-conversion">Pixmap Conversion</a>.</p>
