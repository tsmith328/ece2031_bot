...
<p>In addition to the functions provided by <a href="qvector.html">QVector</a>, QPolygonF provides the <a href="qpolygonf.html#boundingRect">boundingRect</a>() and <a href="qpolygonf.html#translate">translate</a>() functions for geometry
operations. Use the <a href="qmatrix.html#map">QMatrix.map</a>()
function for more general transformations of QPolygonFs.</p>
<p>QPolygonF also provides the <a href="qpolygonf.html#isClosed">isClosed</a>() function to determine
whether a polygon's start and end points are the same, and the
<a href="qpolygonf.html#toPolygon">toPolygon</a>() function
returning an integer precision copy of this polygon.</p>
<p>The QPolygonF class is <a href="implicit-sharing.html#implicit-data-sharing">implicitly
shared</a>.</p>
...
<h3 class="fn"><a name="QPolygonF-2" />QPolygonF.__init__ (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>a</i>)</h3><p>Constructs a polygon of the given <i>size</i>. Creates an empty
polygon if <i>size</i> == 0.</p>
<p><b>See also</b> <a href="qvector.html#isEmpty">QVector.isEmpty</a>().</p>


<h3 class="fn"><a name="QPolygonF-3" />QPolygonF.__init__ (<i>self</i>, list-of-QPointF&#160;<i>v</i>)</h3><p>Constructs a copy of the given <i>polygon</i>.</p>
...
<h3 class="fn"><a name="QPolygonF-5" />QPolygonF.__init__ (<i>self</i>, <a href="qpolygon.html">QPolygon</a>&#160;<i>a</i>)</h3><p>Constructs a closed polygon from the specified
<i>rectangle</i>.</p>
<p>The polygon contains the four vertices of the rectangle in
clockwise order starting and ending with the top-left vertex.</p>
<p><b>See also</b> <a href="qpolygonf.html#isClosed">isClosed</a>().</p>


<h3 class="fn"><a name="QPolygonF-6" />QPolygonF.__init__ (<i>self</i>, int&#160;<i>asize</i>)</h3><p>Constructs a float based polygon from the specified integer
based <i>polygon</i>.</p>
...
<h3 class="fn"><a name="clear" />QPolygonF.clear (<i>self</i>)</h3><h3 class="fn"><a name="contains" />bool QPolygonF.contains (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="containsPoint" />bool QPolygonF.containsPoint (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>pt</i>, <a href="qt.html#FillRule-enum">Qt.FillRule</a>&#160;<i>fillRule</i>)</h3><p>Returns true if the given <i>point</i> is inside the polygon
according to the specified <i>fillRule</i>; otherwise returns
false.</p>
<p>This function was introduced in Qt 4.3.</p>


<h3 class="fn"><a name="count" />int QPolygonF.count (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="count-2" />int QPolygonF.count (<i>self</i>)</h3><h3 class="fn"><a name="data" />sip.voidptr QPolygonF.data (<i>self</i>)</h3><h3 class="fn"><a name="fill" />QPolygonF.fill (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>, int&#160;<i>size</i>&#160;=&#160;-1)</h3><h3 class="fn"><a name="first" /><a href="qpointf.html">QPointF</a> QPolygonF.first (<i>self</i>)</h3><h3 class="fn"><a name="indexOf" />int QPolygonF.indexOf (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>, int&#160;<i>from</i>&#160;=&#160;0)</h3><h3 class="fn"><a name="insert" />QPolygonF.insert (<i>self</i>, int&#160;<i>i</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="intersected" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.intersected (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>r</i>)</h3><p>Returns a polygon which is the intersection of this polygon and
<i>r</i>.</p>
...
<h3 class="fn"><a name="swap" />QPolygonF.swap (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>other</i>)</h3><p>Swaps polygon <i>other</i> with this polygon. This operation is
very fast and never fails.</p>
<p>This function was introduced in Qt 4.8.</p>


<h3 class="fn"><a name="toPolygon" /><a href="qpolygon.html">QPolygon</a> QPolygonF.toPolygon (<i>self</i>)</h3><p>Creates and returns a <a href="qpolygon.html">QPolygon</a> by
converting each <a href="qpointf.html">QPointF</a> to a <a href="qpoint.html">QPoint</a>.</p>
<p><b>See also</b> <a href="qpointf.html#toPoint">QPointF.toPoint</a>().</p>


<h3 class="fn"><a name="translate" />QPolygonF.translate (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>offset</i>)</h3><p>Translate all points in the polygon by the given
<i>offset</i>.</p>
<p><b>See also</b> <a href="qpolygonf.html#translated">translated</a>().</p>


<h3 class="fn"><a name="translate-2" />QPolygonF.translate (<i>self</i>, float&#160;<i>dx</i>, float&#160;<i>dy</i>)</h3><p>This is an overloaded function.</p>
<p>Translates all points in the polygon by (<i>dx</i>,
<i>dy</i>).</p>
<p><b>See also</b> <a href="qpolygonf.html#translated">translated</a>().</p>


<h3 class="fn"><a name="translated" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.translated (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>offset</i>)</h3><p>Returns a copy of the polygon that is translated by the given
<i>offset</i>.</p>
<p>This function was introduced in Qt 4.6.</p>
<p><b>See also</b> <a href="qpolygonf.html#translate">translate</a>().</p>


<h3 class="fn"><a name="translated-2" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.translated (<i>self</i>, float&#160;<i>dx</i>, float&#160;<i>dy</i>)</h3><p>This is an overloaded function.</p>
<p>Returns a copy of the polygon that is translated by (<i>dx</i>,
<i>dy</i>).</p>
<p>This function was introduced in Qt 4.6.</p>
<p><b>See also</b> <a href="qpolygonf.html#translate">translate</a>().</p>


<h3 class="fn"><a name="united" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.united (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>r</i>)</h3><p>Returns a polygon which is the union of this polygon and
<i>r</i>.</p>
<p>Set operations on polygons will treat the polygons as areas.
Non-closed polygons will be treated as implicitly closed.</p>
<p>This function was introduced in Qt 4.3.</p>
<p><b>See also</b> <a href="qpolygonf.html#intersected">intersected</a>() and <a href="qpolygonf.html#subtracted">subtracted</a>().</p>
<h3 class="fn"><a name="value" /><a href="qpointf.html">QPointF</a> QPolygonF.value (<i>self</i>, int&#160;<i>i</i>)</h3><h3 class="fn"><a name="value-2" /><a href="qpointf.html">QPointF</a> QPolygonF.value (<i>self</i>, int&#160;<i>i</i>, <a href="qpointf.html">QPointF</a>&#160;<i>defaultValue</i>)</h3><h3 class="fn"><a name="__add__" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__add__ (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__contains__" />int QPolygonF.__contains__ (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="__delitem__" />QPolygonF.__delitem__ (<i>self</i>, int&#160;<i>i</i>)</h3><h3 class="fn"><a name="__delitem__-2" />QPolygonF.__delitem__ (<i>self</i>, slice&#160;<i>slice</i>)</h3><h3 class="fn"><a name="__eq__" />bool QPolygonF.__eq__ (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__getitem__" /><a href="qpointf.html">QPointF</a> QPolygonF.__getitem__ (<i>self</i>, int&#160;<i>i</i>)</h3><h3 class="fn"><a name="__getitem__-2" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__getitem__ (<i>self</i>, slice&#160;<i>slice</i>)</h3><h3 class="fn"><a name="__iadd__" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__iadd__ (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__iadd__-2" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__iadd__ (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="__len__" /> QPolygonF.__len__ (<i>self</i>)</h3><h3 class="fn"><a name="__lshift__" />object QPolygonF.__lshift__ (<i>self</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="__mul__" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__mul__ (<i>self</i>, <a href="qmatrix.html">QMatrix</a>&#160;<i>m</i>)</h3><h3 class="fn"><a name="__mul__-2" /><a href="qpolygonf.html">QPolygonF</a> QPolygonF.__mul__ (<i>self</i>, <a href="qtransform.html">QTransform</a>&#160;<i>m</i>)</h3><h3 class="fn"><a name="__ne__" />bool QPolygonF.__ne__ (<i>self</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__setitem__" />QPolygonF.__setitem__ (<i>self</i>, int&#160;<i>i</i>, <a href="qpointf.html">QPointF</a>&#160;<i>value</i>)</h3><h3 class="fn"><a name="__setitem__-2" />QPolygonF.__setitem__ (<i>self</i>, slice&#160;<i>slice</i>, <a href="qpolygonf.html">QPolygonF</a>&#160;<i>list</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.10.4 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://qt.digia.com">Digia</a> 2014</td><td align="right" width="25%">Qt&#160;4.8.5</td></tr></table></div></address></body></html>