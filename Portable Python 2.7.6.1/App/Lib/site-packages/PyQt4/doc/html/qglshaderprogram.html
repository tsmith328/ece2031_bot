...
<h3 class="fn"><a name="setAttributeArray" />QGLShaderProgram.setAttributeArray (<i>self</i>, int&#160;<i>location</i>, sequence&#160;<i>values</i>)</h3><p>Sets an array of vertex <i>values</i> on the attribute at
...
<h3 class="fn"><a name="setAttributeArray-2" />QGLShaderProgram.setAttributeArray (<i>self</i>, str&#160;<i>name</i>, sequence&#160;<i>values</i>)</h3><p>Sets an array of 2D vertex <i>values</i> on the attribute at
...
<h3 class="fn"><a name="setUniformValueArray" />QGLShaderProgram.setUniformValueArray (<i>self</i>, int&#160;<i>location</i>, sequence&#160;<i>values</i>)</h3><p>Sets the uniform variable array at <i>location</i> in the
...
<h3 class="fn"><a name="setUniformValueArray-2" />QGLShaderProgram.setUniformValueArray (<i>self</i>, str&#160;<i>name</i>, sequence&#160;<i>values</i>)</h3><p>Sets the uniform variable array at <i>location</i> in the
current context to the <i>count</i> elements of <i>values</i>.</p>
<p><b>See also</b> <a href="qglshaderprogram.html#setAttributeValue">setAttributeValue</a>().</p>


<h3 class="fn"><a name="shaders" />list-of-QGLShader QGLShaderProgram.shaders (<i>self</i>)</h3><p>Returns a list of all shaders that have been added to this
