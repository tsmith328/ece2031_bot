...
<html><head><title>QVBoxLayout Class Reference</title><style>h3.fn,span.fn { margin-left: 1cm; text-indent: -1cm }
a:link { color: #004faf; text-decoration: none }
a:visited { color: #672967; text-decoration: none }
td.postheader { font-family: sans-serif }
tr.address { font-family: sans-serif }
body { background: #ffffff; color: black; }
</style></head><body><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr /><td align="left" valign="top" width="32"><img align="left" border="0" height="32" src="images/rb-logo.png" width="32" /></td><td width="1">&#160;&#160;</td><td class="postheader" valign="center"><a href="index.html"><font color="#004faf">Home</font></a>&#160;&#183; <a href="classes.html"><font color="#004faf">All Classes</font></a>&#160;&#183; <a href="modules.html"><font color="#004faf">Modules</font></a></td></table><h1 align="center">QVBoxLayout Class Reference<br /><sup><sup>[<a href="qtgui.html">QtGui</a> module]</sup></sup></h1><p>The QVBoxLayout class lines up widgets vertically. <a href="#details">More...</a></p>

<p>Inherits <a href="qboxlayout.html">QBoxLayout</a>.</p><h3>Methods</h3><ul><li><div class="fn" /><b><a href="qvboxlayout.html#QVBoxLayout">__init__</a></b> (<i>self</i>)</li><li><div class="fn" /><b><a href="qvboxlayout.html#QVBoxLayout-2">__init__</a></b> (<i>self</i>, QWidget&#160;<i>parent</i>)</li></ul><a name="details" /><hr /><h2>Detailed Description</h2><p>The QVBoxLayout class lines up widgets vertically.</p>
<p>This class is used to construct vertical box layout objects. See
<a href="qboxlayout.html">QBoxLayout</a> for details.</p>
...
parent.</p>
<p class="centerAlign"><img alt="Horizontal box layout with five child widgets" src="images/qvboxlayout-with-5-children.png" /></p>
<hr /><h2>Method Documentation</h2><h3 class="fn"><a name="QVBoxLayout" />QVBoxLayout.__init__ (<i>self</i>)</h3><p>Constructs a new vertical box. You must add it to another
layout.</p>


<h3 class="fn"><a name="QVBoxLayout-2" />QVBoxLayout.__init__ (<i>self</i>, <a href="qwidget.html">QWidget</a>&#160;<i>parent</i>)</h3><p>The <i>parent</i> argument, if not None, causes <i>self</i> to be owned by Qt instead of PyQt.</p><p>Constructs a new top-level vertical box with parent
<i>parent</i>.</p>
