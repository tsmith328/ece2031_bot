...
<h3 class="fn"><a name="setWinPageSize" />QPrinter.setWinPageSize (<i>self</i>, int&#160;<i>winPageSize</i>)</h3><p>Sets the page size to be used by the printer under Windows to
<i>pageSize</i>.</p>
<p><b>Warning:</b> This function is not portable so you may prefer
to use <a href="qprinter.html#setPaperSize">setPaperSize</a>()
instead.</p>
<p><b>See also</b> <a href="qprinter.html#winPageSize">winPageSize</a>().</p>
...
<h3 class="fn"><a name="winPageSize" />int QPrinter.winPageSize (<i>self</i>)</h3><p>Returns the page size used by the printer under Windows.</p>
<p><b>Warning:</b> This function is not portable so you may prefer
to use <a href="qprinter.html#paperSize">paperSize</a>()
instead.</p>
<p><b>See also</b> <a href="qprinter.html#setWinPageSize">setWinPageSize</a>().</p>
