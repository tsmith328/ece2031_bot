...
<p>Setting the style before a palette has been set, i.e., before
...
<h3 class="fn"><a name="widgetAt-2" /><a href="qwidget.html">QWidget</a> QApplication.widgetAt (int&#160;<i>x</i>, int&#160;<i>y</i>)</h3><h3 class="fn"><a name="windowIcon" /><a href="qicon.html">QIcon</a> QApplication.windowIcon ()</h3><hr /><h2>Qt Signal Documentation</h2><h3 class="fn"><a name="commitDataRequest" />void commitDataRequest (QSessionManager&amp;)</h3><p>This is the default overload of this signal.</p><p>This signal deals with <a href="session.html">session
