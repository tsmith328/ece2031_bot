...
given <tt>model</tt>, beginning at the <tt>topLeft</tt>, and ending
at the <tt>bottomRight</tt>.</p>
<pre class="cpp">
 <span class="type">QItemSelection</span> <span class="operator">*</span>selection <span class="operator">=</span> <span class="keyword">new</span> <span class="type">QItemSelection</span>(topLeft<span class="operator">,</span> bottomRight);
</pre>
<p>An empty item selection can be constructed, and later populated
...
following way:</p>
<pre class="cpp">
 <span class="type">QItemSelection</span> <span class="operator">*</span>selection <span class="operator">=</span> <span class="keyword">new</span> <span class="type">QItemSelection</span>();
 <span class="operator">.</span><span class="operator">.</span><span class="operator">.</span>
 selection<span class="operator">-</span><span class="operator">&gt;</span><a href="qitemselection.html#select">select</a>(topLeft<span class="operator">,</span> bottomRight);
</pre>
<p>QItemSelection saves memory, and avoids unnecessary work, by
