...
<html><head><title>QGLFramebufferObjectFormat Class Reference</title><style>h3.fn,span.fn { margin-left: 1cm; text-indent: -1cm }
a:link { color: #004faf; text-decoration: none }
a:visited { color: #672967; text-decoration: none }
td.postheader { font-family: sans-serif }
tr.address { font-family: sans-serif }
body { background: #ffffff; color: black; }
</style></head><body><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr /><td align="left" valign="top" width="32"><img align="left" border="0" height="32" src="images/rb-logo.png" width="32" /></td><td width="1">&#160;&#160;</td><td class="postheader" valign="center"><a href="index.html"><font color="#004faf">Home</font></a>&#160;&#183; <a href="classes.html"><font color="#004faf">All Classes</font></a>&#160;&#183; <a href="modules.html"><font color="#004faf">Modules</font></a></td></table><h1 align="center">QGLFramebufferObjectFormat Class Reference<br /><sup><sup>[<a href="qtopengl.html">QtOpenGL</a> module]</sup></sup></h1><p>The QGLFramebufferObjectFormat class specifies the format of an
OpenGL framebuffer object. <a href="#details">More...</a></p>

<h3>Methods</h3><ul><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#QGLFramebufferObjectFormat">__init__</a></b> (<i>self</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#QGLFramebufferObjectFormat-2">__init__</a></b> (<i>self</i>, QGLFramebufferObjectFormat&#160;<i>other</i>)</li><li><div class="fn" />QGLFramebufferObject.Attachment <b><a href="qglframebufferobjectformat.html#attachment">attachment</a></b> (<i>self</i>)</li><li><div class="fn" />int <b><a href="qglframebufferobjectformat.html#internalTextureFormat">internalTextureFormat</a></b> (<i>self</i>)</li><li><div class="fn" />bool <b><a href="qglframebufferobjectformat.html#mipmap">mipmap</a></b> (<i>self</i>)</li><li><div class="fn" />int <b><a href="qglframebufferobjectformat.html#samples">samples</a></b> (<i>self</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#setAttachment">setAttachment</a></b> (<i>self</i>, QGLFramebufferObject.Attachment&#160;<i>attachment</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#setInternalTextureFormat">setInternalTextureFormat</a></b> (<i>self</i>, int&#160;<i>internalTextureFormat</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#setMipmap">setMipmap</a></b> (<i>self</i>, bool&#160;<i>enabled</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#setSamples">setSamples</a></b> (<i>self</i>, int&#160;<i>samples</i>)</li><li><div class="fn" /><b><a href="qglframebufferobjectformat.html#setTextureTarget">setTextureTarget</a></b> (<i>self</i>, int&#160;<i>target</i>)</li><li><div class="fn" />int <b><a href="qglframebufferobjectformat.html#textureTarget">textureTarget</a></b> (<i>self</i>)</li></ul><h3>Special Methods</h3><ul><li><div class="fn" />bool <b><a href="qglframebufferobjectformat.html#__eq__">__eq__</a></b> (<i>self</i>, QGLFramebufferObjectFormat&#160;<i>other</i>)</li><li><div class="fn" />bool <b><a href="qglframebufferobjectformat.html#__ne__">__ne__</a></b> (<i>self</i>, QGLFramebufferObjectFormat&#160;<i>other</i>)</li></ul><a name="details" /><hr /><h2>Detailed Description</h2><p>The QGLFramebufferObjectFormat class specifies the format of an
...
<h3 class="fn"><a name="mipmap" />bool QGLFramebufferObjectFormat.mipmap (<i>self</i>)</h3><p>Returns true if mipmapping is enabled.</p>
...
<h3 class="fn"><a name="setMipmap" />QGLFramebufferObjectFormat.setMipmap (<i>self</i>, bool&#160;<i>enabled</i>)</h3><p>Enables mipmapping if <i>enabled</i> is true; otherwise disables
it.</p>
<p>Mipmapping is disabled by default.</p>
<p>If mipmapping is enabled, additional memory will be allocated
for the mipmap levels. The mipmap levels can be updated by binding
the texture and calling glGenerateMipmap(). Mipmapping cannot be
enabled for multisampled framebuffer objects.</p>
<p>This function was introduced in Qt 4.8.</p>
...
<h3 class="fn"><a name="__eq__" />bool QGLFramebufferObjectFormat.__eq__ (<i>self</i>, <a href="qglframebufferobjectformat.html">QGLFramebufferObjectFormat</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__ne__" />bool QGLFramebufferObjectFormat.__ne__ (<i>self</i>, <a href="qglframebufferobjectformat.html">QGLFramebufferObjectFormat</a>&#160;<i>other</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.10.4 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://qt.digia.com">Digia</a> 2014</td><td align="right" width="25%">Qt&#160;4.8.5</td></tr></table></div></address></body></html>