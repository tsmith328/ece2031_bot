...
<h3 class="fn"><a name="currentThreadId" />sip.voidptr QThread.currentThreadId ()</h3><p>Returns the thread handle of the currently executing thread.</p>
