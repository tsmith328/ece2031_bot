...
<h3 class="fn"><a name="addChildren" />QTreeWidgetItem.addChildren (<i>self</i>, list-of-QTreeWidgetItem&#160;<i>children</i>)</h3><p>The <i>children</i> argument has it's ownership transferred to Qt.</p><p>Appends the given list of <i>children</i> to the item.</p>
<p>This function was introduced in Qt 4.1.</p>
...
<h3 class="fn"><a name="insertChildren" />QTreeWidgetItem.insertChildren (<i>self</i>, int&#160;<i>index</i>, list-of-QTreeWidgetItem&#160;<i>children</i>)</h3><p>The <i>children</i> argument has it's ownership transferred to Qt.</p><p>Inserts the given list of <i>children</i> into the list of the
...
<h3 class="fn"><a name="takeChildren" />list-of-QTreeWidgetItem QTreeWidgetItem.takeChildren (<i>self</i>)</h3><p>The <i>list-of-QTreeWidgetItem</i> result</p><p>Removes the list of children and returns it, otherwise returns
an empty list.</p>
<p>This function was introduced in Qt 4.1.</p>
