...
<h3 class="fn"><a name="QTextLayout-4" />QTextLayout.__init__ (<i>self</i>, <a href="qtextblock.html">QTextBlock</a>&#160;<i>b</i>)</h3><h3 class="fn"><a name="additionalFormats" />list-of-QTextLayout.FormatRange QTextLayout.additionalFormats (<i>self</i>)</h3><p>Returns the list of additional formats supported by the text
layout.</p>
...
<h3 class="fn"><a name="draw" />QTextLayout.draw (<i>self</i>, <a href="qpainter.html">QPainter</a>&#160;<i>p</i>, <a href="qpointf.html">QPointF</a>&#160;<i>pos</i>, list-of-QTextLayout.FormatRange&#160;<i>selections</i>&#160;=&#160;list-of-QTextLayout.FormatRange, <a href="qrectf.html">QRectF</a>&#160;<i>clip</i>&#160;=&#160;QRectF())</h3><p>Draws the whole layout on the painter <i>p</i> at the position
...
<h3 class="fn"><a name="glyphRuns" />list-of-QGlyphRun QTextLayout.glyphRuns (<i>self</i>)</h3><p>Returns the glyph indexes and positions for all glyphs in this
...
<h3 class="fn"><a name="setAdditionalFormats" />QTextLayout.setAdditionalFormats (<i>self</i>, list-of-QTextLayout.FormatRange&#160;<i>overrides</i>)</h3><p>Sets the additional formats supported by the text layout to
<i>formatList</i>.</p>
<p><b>See also</b> <a href="qtextlayout.html#additionalFormats">additionalFormats</a>() and
