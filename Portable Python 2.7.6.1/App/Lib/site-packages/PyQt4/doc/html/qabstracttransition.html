...
<hr /><h2>Method Documentation</h2><h3 class="fn"><a name="QAbstractTransition" />QAbstractTransition.__init__ (<i>self</i>, <a href="qstate.html">QState</a>&#160;<i>sourceState</i>&#160;=&#160;None)</h3><p>The <i>sourceState</i> argument, if not None, causes <i>self</i> to be owned by Qt instead of PyQt.</p><p>Constructs a new <a href="qabstracttransition.html">QAbstractTransition</a> object with the
