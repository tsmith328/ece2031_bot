...
<h3 class="fn"><a name="swap" />QPicture.swap (<i>self</i>, <a href="qpicture.html">QPicture</a>&#160;<i>other</i>)</h3><p>Swaps picture <i>other</i> with this picture. This operation is
