...
<h3 class="fn"><a name="setOptions" />QPageSetupDialog.setOptions (<i>self</i>, <a href="qpagesetupdialog-pagesetupdialogoptions.html">PageSetupDialogOptions</a>&#160;<i>options</i>)</h3><h3 class="fn"><a name="setVisible" />QPageSetupDialog.setVisible (<i>self</i>, bool&#160;<i>visible</i>)</h3><p>Reimplemented from <a href="qwidget.html#visible-prop">QWidget.setVisible</a>().</p>


<h3 class="fn"><a name="testOption" />bool QPageSetupDialog.testOption (<i>self</i>, <a href="qpagesetupdialog.html#PageSetupDialogOption-enum">PageSetupDialogOption</a>&#160;<i>option</i>)</h3><p>Returns true if the given <i>option</i> is enabled; otherwise,
returns false.</p>
